...
| [Documentation](https://monarch-initiative.github.io/pantherdb-orthologs-ingest) |

ortholog ingest from pantherdb
...
Download the data for the pantherdb_orthologs_ingest transform:

```bash
poetry run pantherdb_orthologs_ingest download
```

To run the Koza transform for pantherdb-orthologs-ingest:

```bash
poetry run pantherdb_orthologs_ingest transform
```

To see available options:

```bash
poetry run pantherdb_orthologs_ingest download --help
# or
poetry run pantherdb_orthologs_ingest transform --help
```
